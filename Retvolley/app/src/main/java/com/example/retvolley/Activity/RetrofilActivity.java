...
import com.example.retvolley.adapter.UserAdapter;
...
public class RetrofilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrofil);
    ...
    private void getUserFromAPI() {
        ...
        Retrofit.Builder builder = new Retrofit.Builder()
                .baseUrl("http://192.168.43.51/volley")
